...
export type mutation_rootKeySpecifier = ('delete_z_minttokens' | 'delete_z_minttokens_by_pk' | 'delete_z_secondary_marketplace' | 'delete_z_secondary_marketplace_by_pk' | 'delete_z_users' | 'delete_z_users_by_pk' | 'insert_z_minttokens' | 'insert_z_minttokens_one' | 'insert_z_secondary_marketplace' | 'insert_z_secondary_marketplace_one' | 'insert_z_users' | 'insert_z_users_one' | 'update_z_minttokens' | 'update_z_minttokens_by_pk' | 'update_z_minttokens_many' | 'update_z_secondary_marketplace' | 'update_z_secondary_marketplace_by_pk' | 'update_z_secondary_marketplace_many' | 'update_z_users' | 'update_z_users_by_pk' | 'update_z_users_many' | mutation_rootKeySpecifier)[];
...
export type query_rootKeySpecifier = ('z_minttokens' | 'z_minttokens_aggregate' | 'z_minttokens_by_pk' | 'z_secondary_marketplace' | 'z_secondary_marketplace_aggregate' | 'z_secondary_marketplace_by_pk' | 'z_users' | 'z_users_aggregate' | 'z_users_by_pk' | query_rootKeySpecifier)[];
...
export type z_secondary_marketplaceKeySpecifier = ('amount' | 'buyer_id' | 'created_at' | 'id' | 'minttoken_id' | 'owner_id' | 'tokens' | 'tx_hash' | 'z_buyer_user' | 'z_minttoken' | 'z_user' | z_secondary_marketplaceKeySpecifier)[];
export type z_secondary_marketplaceFieldPolicy = {
	...
	tx_hash?: FieldPolicy<any> | FieldReadFunction<any>,
	z_buyer_user?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type z_secondary_marketplace_max_fieldsKeySpecifier = ('amount' | 'buyer_id' | 'created_at' | 'id' | 'minttoken_id' | 'owner_id' | 'tokens' | 'tx_hash' | z_secondary_marketplace_max_fieldsKeySpecifier)[];
...
export type z_secondary_marketplace_min_fieldsKeySpecifier = ('amount' | 'buyer_id' | 'created_at' | 'id' | 'minttoken_id' | 'owner_id' | 'tokens' | 'tx_hash' | z_secondary_marketplace_min_fieldsKeySpecifier)[];
