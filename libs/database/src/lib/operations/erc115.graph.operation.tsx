...
export type GetTokenBalanceQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetTokenBalanceQuery = { __typename: 'Query', accounts: Array<{ __typename: 'Account', id: string, ERC1155balances: Array<{ __typename: 'ERC1155Balance', valueExact: string, token: { __typename: 'ERC1155Token', identifier: string }, account: { __typename: 'Account', id: string } | null }> }> };
